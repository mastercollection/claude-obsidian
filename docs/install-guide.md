...
- Set up `wiki/index.md`, `wiki/meta/context-state.json`, `wiki/hot.md`, `wiki/log.md`, and `wiki/overview.md`
...
2. If it looks stale or incomplete, read `wiki/meta/context-state.json`
3. If not enough, read wiki/index.md
4. If you need domain details, read the relevant wiki page
